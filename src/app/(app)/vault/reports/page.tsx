...
import { VaultReportCard } from "@/components/vault/vault-report-card";
...
export default async function VaultReportsPage() {
        ...
        {periods.map(({ period, periodStart }, i) => (
          <TabsContent key={period} value={period}>
            <VaultReportCard
              ...
              initialReport={(reports[i]?.summary as VaultReportSummary | undefined) ?? null}
            />
          </TabsContent>
        ))}
      </Tabs>
