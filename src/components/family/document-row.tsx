...
import { deleteDocumentAction } from "@/server/actions/family";
...
export function DocumentRow({
  ...
  return (
    <div className={cn("flex items-start gap-3 rounded-xl border p-3", isPending && "opacity-60")}>
      ...
      <DocumentFormDialog open={editOpen} onOpenChange={setEditOpen} mode="edit" document={doc} members={members} />
    </div>
  );
}
